...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{SCREENSHOTS/user/landing.png}
    \caption{User Landing Page}
    \label{fig:user-landing}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{SCREENSHOTS/user/booking.png}
    \caption{User Booking}
    \label{fig:user-booking}
\end{figure}
\paragraph{Comment:} The screenshot shows the user booking interface of the CNAS Virtual Counter. Users can select their desired service, choose a preferred date and time slot, and confirm their appointment. The interface is designed to be user-friendly and intuitive, allowing users to easily navigate and complete the booking process.


\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{SCREENSHOTS/user/user-appointments.png}
    \caption{User Appointments}
    \label{fig:user-appointments}
\end{figure}
\paragraph{Comment:} The screenshot displays the user appointments interface of the CNAS Virtual Counter. Users can view their upcoming appointments, check appointment details such as date, time, and location, and even cancel or reschedule appointments if needed. The interface provides users with a clear overview of their scheduled appointments, helping them stay organized and manage their time effectively.
